...
#url_1 = 'streamlit/csv/geodata.csv' # Data of geographic points of the stores
url_2 = 'streamlit/csv/pro_pre_pdv.csv' # Data of products-Prices-stores
url_3 = 'streamlit/csv/pre.csv'# Data of prices
url_4 = 'streamlit/csv/pro.csv' # DATA DE PRODUCTOS
url_5 = 'streamlit/csv/ago_pdv_pro.csv' # Data of products out stock for store and type of product
url_6 = 'streamlit/csv/ago.csv' # DATA DE AGOTADOS
